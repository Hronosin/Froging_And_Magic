...
public class ForgingAndMagicModBlocks {
	...
	public static final DeferredBlock<Block> COREOFINFERNALFURNACE;
	static {
		...
		COREOFINFERNALFURNACE = REGISTRY.register("coreofinfernalfurnace", CoreofinfernalfurnaceBlock::new);
	}
