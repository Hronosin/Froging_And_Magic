...
import net.mcreator.forgingandmagic.procedures.AquatintShovelPriRazrushieniiBlokaInstrumientomProcedure;
import net.mcreator.forgingandmagic.init.ForgingAndMagicModItems;

public class AquatintShovelItem extends ShovelItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		AquatintShovelPriRazrushieniiBlokaInstrumientomProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), itemstack);
		return retval;
	}
}