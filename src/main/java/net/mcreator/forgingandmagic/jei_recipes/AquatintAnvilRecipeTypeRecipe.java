...
public class AquatintAnvilRecipeTypeRecipe implements Recipe<RecipeInput> {
	...
	public static class Type implements RecipeType<AquatintAnvilRecipeTypeRecipe> {
		private Type() {
		}

		public static final RecipeType<AquatintAnvilRecipeTypeRecipe> INSTANCE = new Type();
	}

	public static class Serializer implements RecipeSerializer<AquatintAnvilRecipeTypeRecipe> {
		public static final Serializer INSTANCE = new Serializer();
		private static final MapCodec<AquatintAnvilRecipeTypeRecipe> CODEC = RecordCodecBuilder
		...
		@Override
		public MapCodec<AquatintAnvilRecipeTypeRecipe> codec() {
			return CODEC;
		}

		@Override
		public StreamCodec<RegistryFriendlyByteBuf, AquatintAnvilRecipeTypeRecipe> streamCodec() {
			return STREAM_CODEC;
		}

		private static AquatintAnvilRecipeTypeRecipe fromNetwork(RegistryFriendlyByteBuf buf) {
